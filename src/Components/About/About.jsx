          ...
          <div className="">
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-xl font-bold mb-4">
                About Our Social Event Management Services
              </h2>
              <p className="text-gray-700">
                - Planned and executed over 100 social events, including
                weddings, corporate events, and private parties. <br /> -
                Managed budgets, timelines, and logistics for all events.
                <br /> - Coordinated with vendors and suppliers to ensure that
                all aspects of each event were executed smoothly.
                <br /> - Received positive feedback from clients for all events.
              </p>
              ...
              <div className="mb-6">
                <div className="flex justify-between">
                  <span className="text-gray-600 font-bold">
                    {" "}
                    Social Event Management Services
                  </span>
                  <p>
